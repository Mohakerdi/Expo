...
// Initialize all parts with default sizes, we position them in drawOpaque
    : m_ChassisMain(1.8f, 0.4f, 4.2f, "assets/shaders/vertexSh.vert", "assets/shaders/fragSh.frag"),     // Main Red Body
    m_ChassisBottom(1.85f, 0.2f, 3.8f, "assets/shaders/vertexSh.vert", "assets/shaders/fragSh.frag"),  // Black Underbody
    m_Cabin(1.6f, 0.5f, 2.0f, "assets/shaders/vertexSh.vert", "assets/shaders/fragSh.frag"),           // Roof Area
    m_Roof(1.65f, 0.1f, 1.8f, "assets/shaders/vertexSh.vert", "assets/shaders/fragSh.frag"),           // Roof Detail

    m_Hood(1.7f, 0.1f, 1.2f, "assets/shaders/vertexSh.vert", "assets/shaders/fragSh.frag"),             // Front Hood Scoop
    ...
    m_HeadlightL(0.3f, 0.2f, 0.1f, "assets/shaders/vertexSh.vert", "assets/shaders/fragSh.frag"),
    m_HeadlightR(0.3f, 0.2f, 0.1f, "assets/shaders/vertexSh.vert", "assets/shaders/fragSh.frag"),
    ...
    m_SpoilerWing(1.6f, 0.05f, 0.4f, "assets/shaders/vertexSh.vert", "assets/shaders/fragSh.frag"),
...
void PlayerCar::setTex() {
    ...
    // 2. Underbody (Black)
    m_ChassisBottom.setAllFacesTexture("assets/textures/car/dark_grey_metal.jpg");
    m_SpoilerStrutL.setAllFacesTexture("assets/textures/car/dark_grey_metal.jpg");
    m_SpoilerStrutR.setAllFacesTexture("assets/textures/car/dark_grey_metal.jpg");
    ...
    // 5. Lights
    m_HeadlightL.setAllFacesTexture("assets/textures/plan/p11.jpg");
    m_HeadlightR.setAllFacesTexture("assets/textures/plan/p11.jpg");
...
void PlayerCar::UpdateCar(GLFWwindow* window, float dt) {
...
void PlayerCar::drawOpaque() {
    ...
    m_Cabin.setPosition({ 0, 0.85f, -0.3f });
    m_Cabin.drawOpaque();

    // Roof top
    m_Roof.setParentModel(root);
    m_Roof.setPosition({ 0, 1.1f, -0.3f });
    m_Roof.drawOpaque();
    ...
    m_HeadlightL.setPosition({ -0.6f, 0.5f, 1.95f });
    m_HeadlightL.drawOpaque();

    m_HeadlightR.setParentModel(root);
    m_HeadlightR.setPosition({ 0.6f, 0.5f, 1.95f });
    ...
    m_SpoilerWing.setPosition({ 0, 0.95f, -2.0f });
    m_SpoilerWing.setRotation(10.0f, { 1, 0, 0 }); // Slight angle down
